...
//        fetchPost()
        ...
        likeImageView.isHidden = !tweet.opinionOrNot
        voteLabel.text = "\(tweet.vote)"
        
        postLabel.isHidden = !tweet.opinionOrNot
...
//        shareButton.isHidden = viewModel.shouldHideLikeButton
        ...
        likeCountLabel.text = String(tweet.likes)
    }
