...
//        return tf                               これだとplaceholderがいけてないから以下のようにして自然な白のplaceholderを完成させる
    ...
    func attributedButton(_ firstPart: String, _ secondPart: String) -> UIButton {
        ...
        attributedTitle.append(NSMutableAttributedString(string: secondPart, attributes: [NSAttributedString.Key.font: UIFont.boldSystemFont(ofSize: 16), NSAttributedString.Key.foregroundColor: UIColor.black]))
